...
export const LIMITS = {
  ...
  // Відгук зберігається при кожному дотику до зірки, тож ліміт вищий за
  // бронювання: людина цілком може перебрати кілька оцінок і дописати
  // коментар. Але це все ще публічний запис у базу — без стелі не лишаємо.
  review: { limit: 30, windowSec: 600 },
