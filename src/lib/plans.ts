...
const PERMISSION_MIN_PLAN: Partial<Record<Permission, Plan>> = {
  ...
  // Відгуки лишаємо на всіх тарифах, включно з Free. Це не щедрість:
  // саме вони приводять салону нових клієнтів, тобто найкраще доводять,
  // що система приносить гроші. Ховати їх за оплатою — ховати власний
